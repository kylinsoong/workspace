create tablespace KYBPMSPACE datafile 'C:\oracle\product\10.2.0\oradata\KYBPMSPACE.DBF' size 100M;   
create user KYBPMUSER identified by ADMIN default tablespace KYBPMSPACE;   
grant connect,resource,dba to KYBPMUSER;  
